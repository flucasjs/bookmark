...
export default function Footer() {
  return (
    <div className="w-full text-white bg-color-secondary pt-[46px] pb-[43px] lg:pt-[40px] lg:pb-[34px] flex items-center">
      <div className="flex flex-col items-center lg:container lg:flex-row">
        ...
        <div className="flex justify-between lg:ml-auto lg:gap-x-11">
