...
const innerItemLeft1 = {
  hidden: { opacity: 0 },
  show: { opacity: 1 },
};

const innerItemLeft2 = {
  hidden: { opacity: 0, width: 0 },
  show: { opacity: 0.5, width: 120 },
};

const innerItemLeft3 = {
  hidden: { opacity: 0, width: 0 },
  show: { opacity: 0.25, width: 64 },
};
  ...
  return (
    ...
    >
      ...
      >
              ...
              <g fill="#FFF" transform="translate(22.47 17.197)">
                ...
                <g transform="translate(47 6)">
                  <motion.rect
                    ...
                    animate={{ opacity: 0.75, width: 120 }}
                  />
                  <motion.rect
                    height={6}
                    y={14}
        ...
        <motion.g variants={containerLeft} initial="hidden" animate="show">
          <motion.g transform="translate(110 145)" variants={itemLeft}>
            <motion.circle
              variants={innerItemLeft1}
              cx={16}
              cy={16}
              r={16}
              fill="#F98E5D"
          ...
          <motion.g transform="translate(110 201)" variants={itemLeft}>
            <motion.circle
              variants={innerItemLeft1}
              cx={16}
              cy={16}
          ...
          <motion.g transform="translate(110 257)" variants={itemLeft}>
            <motion.circle
              variants={innerItemLeft1}
              cx={16}
              cy={16}
          ...
          <motion.g transform="translate(110 313)" variants={itemLeft}>
            <motion.circle
              variants={innerItemLeft1}
              cx={16}
              cy={16}
